class char:
    ...
    def chooseStats(self):
        ...
        while maxStat > 0:
            ...
            if ras != "strength" or ras != "health" or ras!= "defence" or ras != "magic"or ras !="intellegence"or ras !="speed":
                while ras != "strength" or ras != "health" or ras!= "defence" or ras != "magic"or ras !="intellegence"or ras !="speed":
                    ras= input("Typo or not an option please type again")
    ...
    def __str__(self):
        return "{} is a {} {} from".format(self.name,self.spec,self.clas)
